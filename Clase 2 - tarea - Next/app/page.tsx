...
export default function Home() {
  return (
    <main className="landing">
      ...
      <nav className="cards">
        <Link href="/parseo-iva" className="card-link card-iva">
          <span className="card-icon">📊</span>
          <h2>Parseo IVA</h2>
          <p>Excel (XLSX) → CSV formateado para importación IVA.</p>
        </Link>
        <Link href="/parseo-suss" className="card-link card-suss">
          <span className="card-icon">📄</span>
          <h2>Parseo SUSS</h2>
          <p>CSV → TXT con el formato requerido para SUSS.</p>
        </Link>
        <Link href="/parseo-arciba" className="card-link card-arciba">
          <span className="card-icon">📋</span>
          <h2>Parseo ARCIBA</h2>
          <p>CSV consolidado Arciba → TXT para retenciones AGIP.</p>
        </Link>
        <Link href="/parseo-sicore-ganancias" className="card-link card-sicore">
          <span className="card-icon">📑</span>
